...
// ============================================================================
// CUTLASS GEMM Configuration (matches 72b_blackwell_nvfp4_nvfp4_gemm.cu)
// ============================================================================
...
// Output configuration - FP16 output (not quantized FP4)
...
// Simple linear combination epilogue (no block scale factor generation)
    ...
    float beta)
{
    ...
    for (int batch = 0; batch < L; ++batch) {
        // Get batch pointers - use void* and reinterpret cast since PyTorch 
        // doesn't have native cutlass types
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Use the permuted scale factors which are in the correct layout for CUTLASS
