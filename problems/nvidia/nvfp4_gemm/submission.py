...
// Conversion caching: track last INPUT pointers and dimensions
static const void* g_last_sfa_input = nullptr;
static const void* g_last_sfb_input = nullptr;
static int g_last_conv_M = 0;
static int g_last_conv_N = 0;
static int g_last_conv_K = 0;
static int g_last_conv_L = 0;
    ...
    float beta)
{
    ...
    // Cache conversion: only convert if input pointers or dimensions changed
